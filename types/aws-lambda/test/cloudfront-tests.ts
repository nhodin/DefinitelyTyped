...
const requestHandler: CloudFrontRequestHandler = async (event, context, cb) => {
  ...
  event = viewerRequestWithS3OriginEvent;
  // $ExpectType CloudFrontRequestEvent
  event;
...
const viewerRequestWithCustomOriginEvent: CloudFrontRequestEvent = {
  Records: [
    {
      cf: {
        config: {
        ...
        request: {
          body: {
            action: "read-only",
            data:
              "eyJ1c2VybmFtZSI6IkxhbWJkYUBFZGdlIiwiY29tbWVudCI6IlRoaXMgaXMgcmVxdWVzdCBib2R5In0=",
            encoding: "base64",
...
const viewerRequestWithS3OriginEvent: CloudFrontRequestEvent = {
  Records: [
    {
      cf: {
        config: {
...
const viewerResponseEvent: CloudFrontResponseEvent = {
  Records: [
    {
      cf: {
        config: {
